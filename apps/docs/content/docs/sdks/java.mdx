---
title: Java SDK
description: Official Java client library for RelayAPI. Post to 22 platforms from any JVM application.
icon: Package
---
...
<Callout type="info">
The Java client is generated and released separately from the RelayAPI monorepo. Check the [relay-java repository](https://github.com/relayapi-dev/relay-java) for the surface, coordinates, and version in the release you install.
</Callout>
