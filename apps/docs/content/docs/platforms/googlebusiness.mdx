...
description: Schedule and automate Google Business Profile posts with RelayAPI — standard posts, events, offers, photos, videos, and call-to-action buttons.
icon: googlebusiness
---
...
| Image max size | 5 MiB |
| Video formats | MP4 |
| Video max size | 75 MiB |
...
| Too many media | More than 1 media item was attached | Remove extras. Google Business accepts one photo or one video per post. |
| Unsupported video | The video is not MP4 or exceeds 75 MiB | Supply one public MP4 URL within the RelayAPI limit. |
...
- **One media item per post** — use either one photo or one video; galleries and carousels are not supported.
