...
| Images per pin | 1, or 2–5 in a carousel |
| Videos per pin | 1 |
| Image formats | JPEG, PNG |
| Image max size | 20 MiB |
...
|----------|-------------|
| Max per pin | 5 (2–5 for a carousel) |
| Formats | JPEG, PNG |
| Max file size | 20 MiB each |
...
- **Image carousels contain 2–5 images** — a single image remains a normal image Pin.
- **Generic `gif` attachments are rejected** — RelayAPI's Pinterest publisher accepts JPEG/PNG images and MP4/MOV video, not the channel-neutral GIF media type.
