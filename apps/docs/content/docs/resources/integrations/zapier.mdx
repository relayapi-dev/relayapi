...
Automate social media publishing across 22 platforms using the official RelayAPI app on Zapier. Connect with 7,000+ apps to trigger posts from Google Sheets, Notion, CRMs, and more.
...
| **Upload Media** | Upload bytes through a pre-signed URL and confirm the media record |
