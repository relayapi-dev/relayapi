...
Create a key under **Settings > API Keys** in an existing hosted or self-hosted dashboard. Hosted signup is currently invite-only; [request access](mailto:support@relayapi.dev?subject=RelayAPI%20early%20access) if needed.
