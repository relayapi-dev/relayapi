---
title: n8n
description: Automate social media posting with the official RelayAPI node for n8n. Post to 22 platforms with visual workflows.
---

import { Callout } from 'fumadocs-ui/components/callout';
import { Step, Steps } from 'fumadocs-ui/components/steps';

Automate social media publishing across 22 platforms using the official RelayAPI node for n8n. Build visual workflows with dedicated operations for posts, accounts, media, and webhooks.
...
| **Media** | Create presigned upload intent, List (PUT and confirmation remain caller steps) |
