...
RelayAPI is a unified API that lets you post to 17 social media platforms with a single API call. Connect your social accounts, create posts, and publish everywhere — all through one consistent interface.
...
<Tab value="curl">
```bash
curl https://api.relayapi.dev/v1/connect/twitter/oauth \
