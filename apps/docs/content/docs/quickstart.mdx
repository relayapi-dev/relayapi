...
RelayAPI is a unified API that lets you publish to 21 social, messaging, SMS, and newsletter channels with a single API call. Connect your accounts, create posts, and publish everywhere through one consistent interface.
