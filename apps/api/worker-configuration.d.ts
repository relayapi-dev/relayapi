/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-file=/dev/null --strict-vars=false --env-interface=ApiWorkerEnv` (hash: a06c34358735094a3551a2a09d87e87a)
// Runtime types generated with workerd@1.20260801.1 2026-07-18 global_fetch_strictly_public,nodejs_compat
interface __BaseEnv_ApiWorkerEnv {
	KV: KVNamespace;
	MEDIA_BUCKET: R2Bucket;
	AVATAR_BUCKET: R2Bucket;
	THUMBNAIL_BUCKET: R2Bucket;
	QUEUE_RESCUE_BUCKET: R2Bucket;
	AD_REPORT_BUCKET: R2Bucket;
	...
	MEDIA_PROCESSING_QUEUE: Queue;
	QUEUE_RESCUE_QUEUE: Queue;
	FREE_RATE_LIMITER: RateLimit;
	PRO_RATE_LIMITER: RateLimit;
	FREE_KEY_BURST_LIMITER: RateLimit;
	PRO_KEY_BURST_LIMITER: RateLimit;
	AI: Ai;
	...
	R2_MEDIA_BUCKET_JURISDICTION: string;
	R2_THUMBNAIL_BUCKET_NAME: string;
	R2_THUMBNAIL_BUCKET_JURISDICTION: string;
	AI_EMBEDDING_PROVIDER: string;
	AI_EMBEDDING_MODEL: string;
	AI_INFERENCE_PROVIDER: string;
	AI_INFERENCE_MODEL: string;
	TIKTOK_VERIFIED_URL_PREFIXES: string;
	PUBLIC_LINK_BASE_URL: string;
	APP_BASE_URL: string;
	REALTIME: DurableObjectNamespace<import("./src/index").RealtimeDO>;
	MEDIA_PROCESSOR: DurableObjectNamespace<import("./src/index").MediaProcessorContainer>;
	MEDIA_PROCESSING_WORKFLOW: Workflow<Parameters<import("./src/index").MediaProcessingWorkflow['run']>[0]['payload']>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "RealtimeDO" | "MediaProcessorContainer";
	}
	interface Env extends __BaseEnv_ApiWorkerEnv {}
}
interface ApiWorkerEnv extends __BaseEnv_ApiWorkerEnv {}
type StringifyValues<EnvType extends Record<string, unknown>> = {
	[Binding in keyof EnvType]: EnvType[Binding] extends string ? EnvType[Binding] : string;
};
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "BASELINE_GENERATION" | "PERF_LOGS" | "R2_EVENT_ACCOUNT_ID" | "R2_MEDIA_BUCKET_NAME" | "R2_MEDIA_BUCKET_JURISDICTION" | "R2_THUMBNAIL_BUCKET_NAME" | "R2_THUMBNAIL_BUCKET_JURISDICTION" | "AI_EMBEDDING_PROVIDER" | "AI_EMBEDDING_MODEL" | "AI_INFERENCE_PROVIDER" | "AI_INFERENCE_MODEL" | "TIKTOK_VERIFIED_URL_PREFIXES" | "PUBLIC_LINK_BASE_URL" | "APP_BASE_URL">> {}
}
