...
export const platformIcons: Record<string, ReactNode> = {
	...
	slack: (
		<Svg d="M9 3H7l-.5 4H3v2h3.25l-.75 6H2v2h3.25l-.5 4h2l.5-4h5.5l-.5 4h2l.5-4H18v-2h-3l.75-6H19V7h-3l.5-4h-2L14 7H8.5L9 3zm-.75 6h5.5L13 15H7.5l.75-6z" />
	),
	sms: (
	...
	beehiiv: (
		<Svg d="M4 4h16a2 2 0 0 1 2 2v12a2 2 0 0 1-2 2H4a2 2 0 0 1-2-2V6a2 2 0 0 1 2-2zm0 3.2V18h16V7.2l-8 5-8-5zm1.7-1.2L12 9.94 18.3 6H5.7z" />
	),
	convertkit: <SiIcon icon={siKit} />,
	mailchimp: <SiIcon icon={siMailchimp} />,
	listmonk: <SiIcon icon={siListmonk} />,
};
