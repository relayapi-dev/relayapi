...
export function CTASection() {
    ...
    return (
        ...
        >
            <div className="absolute inset-0 -z-1 h-full w-full bg-radial-[at_45%_85%] from-[#2CD5FF]/25 via-[#2C30FF]/3 mask-[linear-gradient(to_bottom,transparent,black_100%)]" />
            <div className="absolute inset-0 -z-1 h-full w-full bg-radial-[at_45%_68%] from-[#2CD5FF]/40 via-[#2C30FF]/2 mask-[linear-gradient(to_bottom,transparent,black_100%)] blur-[50px]" />
