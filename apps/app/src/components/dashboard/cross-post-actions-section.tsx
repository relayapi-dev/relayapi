...
export const CrossPostActionsTrigger = forwardRef<
	HTMLButtonElement,
	{ count: number } & ComponentPropsWithoutRef<"button">
...
CrossPostActionsTrigger.displayName = "CrossPostActionsTrigger";
...
export function CrossPostActionsPanel({
	...
	onChange,
	className,
}: CrossPostActionsSectionProps & { className?: string }) {
