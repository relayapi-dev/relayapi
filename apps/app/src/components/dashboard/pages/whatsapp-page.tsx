				...
				(templatesLoading ? (
					...
					<div className="rounded-[12px] border border-dashed border-border p-12 text-center">
						...
						<p className="text-xs text-muted-foreground mt-1">
							Create message templates approved by WhatsApp for broadcast
							messaging
						</p>
					</div>
				) : (
			...
			{activeTab === "settings" && (
				<div className="rounded-[12px] border border-dashed border-border p-12 text-center">
					...
					<p className="text-xs text-muted-foreground mt-1 max-w-sm mx-auto">
						Configure your WhatsApp Business API credentials, webhook URLs, and
						message templates via the API.
					</p>
				</div>
			)}
		</div>
