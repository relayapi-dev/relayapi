...
const workflowSteps: WorkflowStep[] = [
    {
        ...
        tokens: "2.4 MB",
        status: "Resizing for each platform...",
        step: "Step 1 of 3",
    },
    {
        id: "2",
        agent: "content-formatter@relay",
        tokens: "280 chars",
        status: "Adapting text per platform...",
        step: "Step 2 of 3",
    },
    {
        id: "3",
        agent: "delivery-engine@relay",
        tokens: "12 targets",
        status: "Publishing to all platforms...",
        step: "Step 3 of 3",
    },
];
