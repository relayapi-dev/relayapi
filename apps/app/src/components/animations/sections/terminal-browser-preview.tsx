...
// Repurposed for Relay: shows API request → response preview
    ...
    return (
        ...
        >
            ...
            <AnimatePresence>
                {status === "preview" && (
                    <BrowserPreview
                        title="Published to 3 platforms"
                        description="Your post is live on Twitter/X, LinkedIn, and Instagram. Track engagement in the dashboard."
                        button={{ text: "View Posts", href: "#" }}
                    />
                )}
            </AnimatePresence>
        </div>
