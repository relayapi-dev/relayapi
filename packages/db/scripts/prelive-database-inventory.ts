...
export const PROVIDER_OPERATION_INVENTORY_CONTRACTS = [
	...
	{
		relation: "public.ad_report_jobs",
		kind: "ad_report_operation",
		stateKey: "status",
		unresolvedStates: [
			"pending",
			"submitting",
		...
		providerKeys: ["ad_account_id", "provider_job_id", "result_object_key"],
	},
	{
		relation: "public.ad_conversion_events",
		kind: "ad_conversion_operation",
		stateKey: "status",
		unresolvedStates: [
			"pending",
			"processing",
		...
		terminalStates: ["completed", "failed", "cancelled"],
		providerKeys: ["ad_account_id", "conversion_rule_id", "provider_event_id"],
	},
	{
		relation: "public.social_mutation_operations",
		kind: "social_mutation_operation",
		stateKey: "status",
		unresolvedStates: [
			"pending",
			"processing",
		...
		providerKeys: ["account_id", "target_id", "provider_operation_id"],
	},
	{
		relation: "public.media_upload_sessions",
		kind: "media_upload_operation",
		stateKey: "status",
		unresolvedStates: [
			"created",
			"uploading",
		...
		terminalStates: ["completed", "aborted", "expired"],
		providerKeys: ["media_id"],
	},
	{
		relation: "public.media_processing_jobs",
		kind: "media_processing_operation",
		stateKey: "status",
		unresolvedStates: ["pending", "processing", "failed", "manual_review"],
		terminalStates: ["completed"],
		providerKeys: ["media_id", "workflow_id"],
	},
	{
